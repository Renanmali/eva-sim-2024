...
class Gui(ttk.Frame):
    def __init__(self, parent):
        ...
        # Define the frame for the checkbox
        self.frame_chk = tkinter.Frame(master=self.frame_memory)
        self.frame_chk.pack(pady=15)
        ...
        # Variables initialized for buttons
        ...
        self.chk_voice = Checkbutton (self.frame_chk, text="Voice", variable=self.chk_voice_value, onvalue= 1, offvalue=0)
        self.chk_voice.pack(side=tkinter.LEFT, padx=self.bt_padx)
        self.chk_handpose = Checkbutton (self.frame_chk, text="HandPose", variable=self.chk_handpose_value, onvalue= 1, offvalue=0)
